...
$secteurs = $base->etablissement_secteur_liste ($_SESSION['token'], NULL, NULL);
...
$pagination->setFunction ('etablissement_liste_details', array ($_SESSION['token'], 
								arrval ($_GET, 'sec_id_role'), 
								arrval ($_GET, 'sec_id_besoin'), 
								FALSE));
$pagination->setUrl ('/admin.php', array ('sec_id_role' => arrval ($_GET, 'sec_id_role'),
					  'sec_id_besoin' => arrval ($_GET, 'sec_id_besoin')
					  ));
...
<?php liste_secteurs (arrval ($_GET, 'sec_id_role'), true); ?>
</select>
<select name="sec_id_besoin">
<option value="">(tous besoins)</option>
<?php liste_secteurs (arrval ($_GET, 'sec_id_besoin'), false); ?>
</select>
...
function lien_edit_etab ($eta_id) {
  return array ('/admin.php', array ('sec_id_role' => arrval ($_GET, 'sec_id_role'),
			             'sec_id_besoin' => arrval ($_GET, 'sec_id_besoin'),
			             'eta' => $eta_id));
}
