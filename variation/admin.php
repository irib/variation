...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
  ...
  <div id="maincopyright"><a href="http://www.variation.fr" target="_blank">VARIATION</a> - Copyright &copy; 2012-2016 actimeo sarl - <a href="http://www.gnu.org/licenses/agpl-3.0.html" target="_blank">Licence GNU Affero GPL</a> - 
  <?php 
    require 'inc/version.inc.php';
    echo "Version ".$version;
?>
</div>
    <input type="hidden" id="token" value="<?= arrval ($_SESSION, 'token', '') ?>"></input>
    <input type="hidden" id="uti_id" value="<?= arrval ($_SESSION, 'uti_id', '') ?>"></input>
    <input type="hidden" id="tsm_id" value="<?= arrval ($_SESSION, 'tsm_id', '') ?>"></input>
    <input type="hidden" id="eta_id" value="<?= arrval ($_SESSION, 'eta_id', '') ?>"></input>
    <div id="dlg"></div>
    <div id="dlg2"></div>
    <div id="dlg_aide"></div>
  </body>
